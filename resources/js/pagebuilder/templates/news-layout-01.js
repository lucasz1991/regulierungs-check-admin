...
export const newsLayoutHtml = [
    ...
    '      <h2><i class="fa-light fal fa-clipboard-list rc-news-summary__icon" aria-hidden="true"></i> Das Wichtigste in Kürze</h2>',
    '      <ul>',
    '        <li><i class="fa-solid fas fa-check rc-news-summary__check" aria-hidden="true"></i><span>BGH stärkt Transparenzpflicht der Versicherer.</span></li>',
    '        <li><i class="fa-solid fas fa-check rc-news-summary__check" aria-hidden="true"></i><span>Leistungsablehnungen müssen klar und nachvollziehbar begründet sein.</span></li>',
    '        <li><i class="fa-solid fas fa-check rc-news-summary__check" aria-hidden="true"></i><span>Das Urteil hat Auswirkungen auf viele laufende Schadensfälle.</span></li>',
    '      </ul>',
    '    </section>',
    '',
    '    <section class="rc-news-meta" aria-label="Artikelinformationen">',
    '      <span><i class="fa-regular far fa-clock rc-news-meta__icon" aria-hidden="true"></i> 5 Min. Lesezeit</span>',
    '      <span><i class="fa-light fal fa-folder-open rc-news-meta__icon" aria-hidden="true"></i> Recht &amp; Urteile</span>',
    '      <a href="#" aria-label="Artikel teilen"><i class="fa-light fal fa-share-nodes rc-news-meta__icon" aria-hidden="true"></i> Artikel teilen</a>',
    '    </section>',
    '',
    ...
    '        <i class="fa-light fal fa-lightbulb rc-news-note__icon" aria-hidden="true"></i>',
    '        <div>',
    '          <h3>Gut zu wissen</h3>',
    ...
    '.rc-news-template .fa-share-nodes::before { content: "\\f1e0"; }',
