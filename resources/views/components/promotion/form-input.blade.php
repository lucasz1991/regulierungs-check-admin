...
<div class="{{ $wrapperClass }}" data-promotion-field="{{ $field }}">
    ...
    <input
        ...
        data-promotion-control="input"
        {{ $attributes->class([
            'mt-2 block w-full rounded-2xl border px-4 py-3 text-sm shadow-sm outline-none transition duration-150 disabled:cursor-not-allowed disabled:opacity-60',
